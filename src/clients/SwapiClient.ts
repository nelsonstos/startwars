...
import { StarWarsCharacterResponseDTO } from './../dtos/StarWarsCharacterResponseDTO'; // Asegúrate de que la ruta sea correcta
import { StarWarsFilmResponseDTO } from '../dtos/StarWarsFilmResponseDTO';
